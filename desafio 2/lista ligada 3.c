...
void insereOrdernado(ListaLigada lista, int info){
...
int main() {
    ...
    BubbleSort(lista);
    printf("Lista Ordernada: \n");
    llPrint(lista);

    int x;

    printf("qual numero vc quer inserir ordenado na lista?\n");
    scanf("%d" ,  &x);

    insereOrdernado(lista, x);
    printf("Lista Ordernada com numero inserido: \n");
    llPrint(lista);
